...
published: true
layout: single
title: "[k8s] Kubernetes Basic Object 정리"
category: k8s
tags:
comments: true
sidebar:
...
인프런 쿠버네티스 초급편 강의 실습 및 정리한 페이지 입니다. (참고로 클러스터는 3개의 Node를 VBox Ubuntu 가상환경으로 구성하였습니다.)
- [쿠버네티스 초급 강의](https://www.inflearn.com/course/%EC%BF%A0%EB%B2%84%EB%84%A4%ED%8B%B0%EC%8A%A4-%EA%B8%B0%EC%B4%88/dashboard)
